...
// Source: https://cdn.zoomcharts-cloud.com/1/latest/zoomcharts.d.ts
declare module 'zoomcharts' {
module ZoomCharts.Configuration {
    /* tslint:disable */
...
module ZoomCharts {
    ...
    export class TimeChart extends Configuration.BaseApi {
        ...
        Use `from: null, to: null` to remove selection.
...
class FacetChart extends ZoomCharts.FacetChart { }
class GeoChart extends ZoomCharts.GeoChart { }
class NetChart extends ZoomCharts.NetChart { }
class PieChart extends ZoomCharts.PieChart { }
class TimeChart extends ZoomCharts.TimeChart { }
